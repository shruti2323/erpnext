...
website_route_rules = [
	...
	{"from_route": "/contracts/<path:name>", "to_route": "contract_detail",
		"defaults": {
			"doctype": "Contract",
...
doc_events = {
	...
	"Contract": {
		"on_submit": "erpnext.crm.doctype.contract.contract.send_contract"
	}
}
...
scheduler_events = {
	...
	"daily": [
		...
		"erpnext.crm.doctype.contract.contract.create_invoices_for_lapsed_contracts"
	]
}
